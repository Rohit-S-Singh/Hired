    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="flex gap-4 mb-8">
          ...
          <button className="flex items-center gap-2 bg-white text-gray-700 px-5 py-3 rounded-lg font-medium hover:bg-gray-50 transition-colors border border-gray-300"  onClick={() => navigate('/MentorCarousel')}>
